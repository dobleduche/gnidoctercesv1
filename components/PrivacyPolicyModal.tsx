  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 id="privacy-title" className="text-2xl font-orbitron font-bold text-cyan mb-4">Privacy Policy</h2>
        
        <div className="text-gray-300 space-y-4 text-sm">
            <p><strong>Last Updated:</strong> {new Date().toLocaleDateString()}</p>
            <p>Welcome to gnidoC terceS ("we", "our", "us"). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.</p>
            
            <h3 className="font-bold text-lg text-gray-100 pt-2">1. Information We Collect</h3>
            <p>We may collect personal information from you in a variety of ways, including, but not limited to, when you use our services, or communicate with us. The types of personal information we may collect include your name, email address, and any other information you choose to provide.</p>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:privacy@gnidoc.xyz" className="text-cyan hover:underline">privacy@gnidoc.xyz</a>.</p>
        </div>
