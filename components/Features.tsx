...
const AiIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    className="h-8 w-8 mb-4 text-cyan"
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
    strokeWidth={1.5}
    role="img"
    aria-labelledby="aiIconTitle"
    {...props}
  >
    <title id="aiIconTitle">AI-Powered Generation Icon</title>
    <path
      strokeLinecap="round"
...
const FullStackIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-8 w-8 mb-4 text-cyan"
    fill="none"
    ...
    strokeWidth={1.5}
    role="img"
    aria-labelledby="fsIconTitle"
    {...props}
  >
    <title id="fsIconTitle">Full-Stack Icon</title>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6 20.25h12m-7.5-3.75v3.75m3.75-3.75v3.75m-7.5-12v12h12v-12h-12z"
    />
  </svg>
);
const SecureIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    strokeWidth={1.5}
    role="img"
    aria-labelledby="secureIconTitle"
    {...props}
  >
    <title id="secureIconTitle">Secure Icon</title>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
const NoCodeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-8 w-8 mb-4 text-cyan"
    fill="none"
    ...
    strokeWidth={1.5}
    role="img"
    aria-labelledby="ncIconTitle"
    {...props}
  >
    <title id="ncIconTitle">No-Code Icon</title>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
const featuresData = [
  {
    ...
    description:
      'Our multi-agent system intelligently interprets your prompt to build every component, from UI to database.',
  },
  {
    icon: <FullStackIcon aria-hidden="true" />,
    title: 'Full-Stack Output',
    description:
      'Receive a complete, shippable codebase including a frontend, backend, and database configuration.',
  },
  {
    icon: <SecureIcon aria-hidden="true" />,
    title: 'Secure & Shippable',
    description:
      'We perform security checks and best practices to ensure your app is ready for production from the start.',
  },
  {
    icon: <NoCodeIcon aria-hidden="true" />,
    title: 'No-Code Simplicity',
    description:
      'Go from idea to deployed application without writing a single line of code. Perfect for founders and creators.',
  },
];
  ...
  return (
    <section id="features" aria-labelledby="features-title" className="py-20 md:py-32">
      <div className="w-full max-w-5xl mx-auto text-center">
        <h2 id="features-title" className="text-3xl md:text-4xl font-orbitron font-bold mb-4">
          Why gnidoC terceS?
        </h2>
        <p className="max-w-2xl mx-auto mb-12 text-gray-600 dark:text-gray-400">
          We're not just a code generator. We're an AI-powered development team at your fingertips.
        </p>
